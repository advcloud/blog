...
var config = {
  ...
  port: process.env.PORT || 1339,//端口号
...
config.rss = {
  ...
  title: "未志",
  description: "写给未来的自己。",
  link: process.env.RSS_LINK || "http://blog.id8.in",
  language: "zh-cn",
  managingEditor: "",
  webMaster: "",
  generator: "blog",
...
exports.db = mongoskin.db(process.env.MONGOLAB_URI || "mongodb://localhost/blog");//数据库连接串
